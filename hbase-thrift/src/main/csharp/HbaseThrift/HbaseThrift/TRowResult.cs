...
/// <summary>
/// Holds row name and then a Dictionary of columns to cells.
/// </summary>
#if !SILVERLIGHT
[Serializable]
#endif
public partial class TRowResult : TBase
{
    ...
    while (true)
    {
      ...
      switch (field.ID)
      {
        case 1:
          ...
          break;
        case 2:
          if (field.Type == TType.Dictionary) {
            {
              Columns = new Dictionary<byte[], TCell>();
              TDictionary _Dictionary4 = iprot.ReadDictionaryBegin();
              for( int _i5 = 0; _i5 < _Dictionary4.Count; ++_i5)
              {
                byte[] _key6;
                TCell _val7;
  ...
  public void Write(TProtocol oprot) {
    ...
    if (Columns != null && __isset.columns) {
      field.Name = "columns";
      field.Type = TType.Dictionary;
      field.ID = 2;
      oprot.WriteFieldBegin(field);
      {
        oprot.WriteDictionaryBegin(new TDictionary(TType.String, TType.Struct, Columns.Count));
        foreach (byte[] _iter8 in Columns.Keys)
        {
          oprot.WriteBinary(_iter8);
          Columns[_iter8].Write(oprot);
        }
        oprot.WriteDictionaryEnd();
      }
      oprot.WriteFieldEnd();
    }
